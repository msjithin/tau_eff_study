...
int main(int argc, const char *argv[])
{
  ...
  tautau_analyzer t(argv[1], argv[2], isMC, SampleName, signalpara);
...
void tautau_analyzer::Loop(Long64_t maxEvents, int reportEvery, string SampleName)
{
  ...
  TH1F *signal_cutflow = new TH1F("signal_cutflow", "signal_cutflow", 10, 0, 10);
  ...
  for (Long64_t jentry = 0; jentry < nentriesToCheck; jentry++)
  {
    ...
    if (debug)
      cout << "signal region -  isolated begin L523" << endl;
  ...
  signal_cutflow->SetBinContent(1, nevents1);
  signal_cutflow->SetBinContent(2, nevents2);
  signal_cutflow->SetBinContent(3, nevents3);
  signal_cutflow->SetBinContent(4, nevents4);
  signal_cutflow->SetBinContent(5, nevents5);
  signal_cutflow->SetBinContent(6, nevents6);
  signal_cutflow->SetBinContent(7, nevents7);
  signal_cutflow->SetBinContent(8, nevents8);
  signal_cutflow->SetBinContent(9, nevents9);
