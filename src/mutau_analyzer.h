...
public:
  ...
  bool thirdLeptonVeto_boosted(int muIndex, int tauIndex);
  ...
  vector<int> bJet_medium_boosted(int muIndex, int tauIndex);
  vector<int> bJet_loose_boosted(int muIndex, int tauIndex);
  ...
  void setMyEleTau_boosted(int eleIndex, int tauIndex, TLorentzVector metP4, int shift);
  void save_nom();
...
void mutau_analyzer::setMyEleTau_boosted(int muIndex, int tauIndex, TLorentzVector event_metP4, int shift)
{
