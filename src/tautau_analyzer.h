...
public :
  ...
  int nevents1, nevents2, nevents3, nevents4, nevents5, nevents6, nevents7, nevents8, nevents9, nevents10;
  ...
  Int_t           run;
   ...
   tautau_analyzer(const char* file1, const char* file2, string isMC, string SampleName, const char* signal_para);
   ~tautau_analyzer();
   ...
   std::vector<int> simple_tau_cand(double pt, double eta, int shift);
   std::vector<int> simple_tau_cand_2(double pt, double eta, int shift);
   ...
   int thirdLeptonVeto();
   bool thirdLeptonVeto(int tau1Index, int tau2Index);
   bool thirdLeptonVeto_boosted(int tau1Index, int tau2Index);
...
tautau_analyzer::tautau_analyzer(const char* file1, const char* file2, string isMC, string sampleName, const char* signal_para)
{
...
nevents1 = nevents2= nevents3= nevents4= nevents5= nevents6= nevents7= nevents8= nevents9= nevents10=0;
...
void tautau_analyzer::setMyEleTau(int tau1Index, int tau2Index, TLorentzVector metP4, int shift){
  ...
  // if(is_MC) my_metP4= corrected_met;
  // else      my_metP4.SetPtEtaPhiE(pfMET ,0,pfMETPhi,pfMET);
