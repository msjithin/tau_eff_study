...
for idx in mzp_map:
	for var, selection, idtype in parameters:
		...
		hist_1 = infile.Get('gen'+var+'_'+idtype+idlist[0]+'_'+selection)
		hist_2 = infile.Get('gen'+var+'_'+idtype+idlist[1]+'_'+selection)
		hist_3 = infile.Get('gen'+var+'_'+idtype+idlist[2]+'_'+selection)
		hist_4 = infile.Get('gen'+var+'_'+idtype+idlist[3]+'_'+selection)
		hist_5 = infile.Get('gen'+var+'_'+idtype+idlist[4]+'_'+selection)
		...
		canv.SaveAs('plots/eff_2017mutau_'+idtype+'_'+signal+'_'+var+'_'+selection+'.png')
